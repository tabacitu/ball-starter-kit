<form wire:submit="destroy" class="p-6">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <x-form-input wire:model="password" label="" class="mt-4" name="password" id="password-delete-confirmation" type="password" placeholder="Enter current password" required />
